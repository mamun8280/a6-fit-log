...
const Banner = () => {
  return (
    <div className="bg-[#13151b] rounded-2xl p-6 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 mt-8 mb-12 mx-[10px] border border-gray-800">
