      ...
      <div className="container mx-auto px-4 md:px-8 py-3 navbar">
        <div className="navbar-start flex items-center gap-2">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-[#181a20] rounded-box z-1 mt-3 w-52 p-2 shadow text-gray-300">
              <li><Link href="/" className={activePage === 'Workouts' ? 'text-[#ccff00] font-bold' : ''}>Workouts</Link></li>
              <li><Link href="/my-plan" className={activePage === 'My Plan' ? 'text-[#ccff00] font-bold' : ''}>My Plan</Link></li>
            </ul>
          </div>
          ...
          <Link href="/" className="flex items-center gap-2.5 hover:opacity-90">
            ...
            <span className="font-extrabold text-xl tracking-wider text-white uppercase">FITLOG</span>
          </Link>
        </div>
        ...
        <div className="navbar-end flex items-center gap-4">
          <Link href="/my-plan" className="flex items-center gap-2 text-sm font-medium text-gray-300 hover:opacity-90 transition-opacity">
            <span>Plan</span>
            <span className="bg-[#ccff00] text-black font-bold w-6 h-6 rounded-full flex items-center justify-center text-xs">{planCount}</span>
          </Link>
          <Link href="/my-plan" className="flex items-center gap-2 text-sm font-medium text-gray-300 hover:opacity-90 transition-opacity">
            <span>Saved</span>
            <span className="border border-gray-600 text-gray-300 font-bold w-6 h-6 rounded-full flex items-center justify-center text-xs">{savedCount}</span>
          </Link>
        </div>
      </div>
    </nav>
